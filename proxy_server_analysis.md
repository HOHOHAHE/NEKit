...
```mermaid
graph LR
    ClientApp -- TCP --> ProxyServerTC[GCDProxyServer]
    ...
    %% Data/Control Flow
    ProxySocketIntf -- Notifies Delegate (Tunnel) --> TunnelTC
    TunnelTC -- Instructs --> ProxySocketIntf
    AdapterSocketIntf -- Notifies Delegate (Tunnel) --> TunnelTC
    TunnelTC -- Instructs --> AdapterSocketIntf
    ProxySocketIntf -- Data --> TunnelTC
    TunnelTC -- Data --> AdapterSocketIntf
    AdapterSocketIntf -- Data --> TunnelTC
    TunnelTC -- Data --> ProxySocketIntf
```
